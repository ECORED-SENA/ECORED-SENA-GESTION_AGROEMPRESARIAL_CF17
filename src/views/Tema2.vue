  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.justify-content-center(data-aos="fade-right")
      .col-lg-10.col-12
        ...
        .row.justify-content-center.p-4(style="background-color:#e8e8e8; border-radius:20px")
          .col-lg-9.col-12
    ...
    ImagenInfograficaB.color-acento-botones.mb-0(data-aos="fade-left")
      ...
      div(x="10.65%" y="34%" tooltip="Relación con Producción" numero="+")        
        p.mb-4 <b>Según su relación con la producción:</b>
        p.mb-4 <b>Costos variables:</b> los cuales clasifican todos aquellos costos susceptibles de variaciones relacionadas con el aumento o disminución de la producción, al estar directamente relacionados con el volumen de producción, es posible predecir su comportamiento en función con la cantidad de unidades de producto terminado requeridas, así, cuanto mayor sea el número de unidades mayor será la adquisición de este tipo de costos y viceversa. 
        p.mb-0 <b>Los costos fijos:</b> los cuales no sufren variaciones en función del aumento o disminución de la producción, es decir, se mantienen como costos fijos, tal es el ejemplo del pago de arrendamiento de planta fija, que independiente al volumen de la producción ,este se mantiene igual por lo menos en un periodo de tiempo definido.
      div(x="44.25%" y="60.6%" tooltip="Relación con Producto" numero="+")        
        p.mb-4 <b>Según su relación con el producto: </b>
        p.mb-4 <b>Los costos directos:</b> que son aquellos que se pueden relacionar de forma inequívoca con el trabajo de elaboración del producto terminado.
        p.mb-0 <b>Los costos indirectos:</b> que corresponden a aquellos que no pueden relacionarse, por lo menos no de manera directa y evidente al proceso de fabricación de los productos, así, en términos prácticos, bajo el ejemplo de producción de automóviles, los sueldos pagados a los ensambladores, serán tomados como costo directo,  pues es una labor que está directamente implicada en el proceso de producción, en cambio los servicios públicos de la fábrica aunque si bien son costos asociados a la etapa de producción, no se puede establecer una relación directa de estos en el proceso de elaboración de los productos.
      div(x="77.7%" y="41.1%" tooltip="Relación con Planeación" numero="+")        
        p.mb-4 <b>Según su uso en planeación: </b>
        p.mb-4 <b>Los costos estimados:</b> los cuales se identifican en base a procesos de observación y deducciones, dado esta condición, sus estimaciones no son exactas y están condicionadas al nivel de detalle con que se halla calculado en los análisis de estimación, entre este tipo de costos se encuentran aquellos insumos que no intervienen directamente en el proceso de trasformación de las materias primas. 
        p.mb-0 <b>Los costos estándar:</b> son aquellos insumos de los cuales las empresas disponen en grandes cantidades, puesto que intervienen directamente en los procesos de producción, por esto son determinantes a la hora de fijar u anticipar el cálculo de los costos de producción, el margen de error en este cálculo es muy bajo dado que, por ser productos que se adquieren en grandes cantidades, las variaciones en sus precios son casi fijas.
    ...
    .fondo3
      ...
      TabsB.color-acento-contenido.mb-0(data-aos="fade-right")
        .py-5.px-5(titulo="Herramienta de costo basado en<br>actividades (ABC) " :icono="require('@/assets/curso/tema2/img11.svg')")
          ...
          .row
            .col-lg-6.col-12
              p.mb-4 El enfoque de este sistema se centra en las actividades ejecutadas en el proceso de producción y no en los productos, por tanto, se enfoca en evaluar todas las actividades requeridas en la elaboración del bien y son a estas a quien se asigna el valor del costo.
              p.mb-mb-lg-0.mb-3 Dicha modalidad permite identificar aquellas actividades que no son necesarias en el proceso, lo que contribuye a hacer más eficientes estos procesos reconociendo así la totalidad de costos realmente necesarios en los procesos de producción.           
            .col-md-6
              img.mb-0(src='@/assets/curso/tema2/img12.png')          
        ...
        .py-5.px-5(titulo="Costeo por absorción" :icono="require('@/assets/curso/tema2/img13.svg')")
          ...
          .row
            .col-lg-6.col-12
              ...
              p.mb-mb-lg-0.mb-3 Sin embargo, el costo final que es asignado al producto suele ser susceptible de variaciones en cortos periodos de tiempo, debido a que están supeditados a los niveles de producción, lo que dificulta su análisis.               
            .col-md-6
              img.mb-0(src='@/assets/curso/tema2/img14.png')     
              p.mb-0.px-4(style="font-size:14px !important") Se cargan todos los costos al producto final, en este caso, producción de tomate orgánico.

        .py-5.px-5(titulo="Costeo variable" :icono="require('@/assets/curso/tema2/img15.svg')")
          h4.mb-4 Prevenir el costo de producción.
          .row
            .col-lg-6.col-12
            ...
            .col-md-6
              img.mb-0(src='@/assets/curso/tema2/img16.png')     
              p.mb-0.px-4(style="font-size:14px !important") Costo de producción promedio en un periodo de tiempo definido, granja de productos vegetales hidropónicos.
